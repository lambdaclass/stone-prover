...
CpuAirDefinition<FieldElementT, 10>::CreateCompositionPolynomial(
  ...
  return builder.BuildUniquePtr(UseOwned(this), gen, trace_length_,
                                random_coefficients.As<FieldElementT>(),
...
CpuAirDefinition<FieldElementT, 10>::PrecomputeDomainEvalsOnCoset(
  ...
  const std::vector<FieldElementT> strict_point_powers =
      BatchPow(point, point_exponents);
  const std::vector<FieldElementT> gen_powers =
      BatchPow(generator, point_exponents);

  // point_powers[i][j] is the evaluation of the ith power at its jth point.
  // The index j runs until the order of the domain (beyond we'd cycle back to
  // point_powers[i][0]).
  ...
  std::vector<std::vector<FieldElementT>> precomp_domains = {
      ...
      FieldElementT::UninitializedVector(2),
      FieldElementT::UninitializedVector(8),
      FieldElementT::UninitializedVector(16),
      FieldElementT::UninitializedVector(16),
  };

  period = 1;
  ASSERT_RELEASE(period < kPeriodUpperBound,
                 "Precomp evals: large dynamic size.");
  task_manager.ParallelFor(
      period,
      [&](const TaskInfo &task_info) {
        for (size_t i = task_info.start_idx; i < task_info.end_idx; ++i) {
          precomp_domains[0][i] =
              (point_powers[0][i & (0)]) - (FieldElementT::One());
        }
      },
      period, kTaskSize);
  ...
  task_manager.ParallelFor(
      ...
      [&](const TaskInfo &task_info) {
        for (size_t i = task_info.start_idx; i < task_info.end_idx; ++i) {
          precomp_domains[1][i] =
              (point_powers[1][i & (1)]) - (FieldElementT::One());
        }
      },
      period, kTaskSize);
  ...
  task_manager.ParallelFor(
      ...
      [&](const TaskInfo &task_info) {
        for (size_t i = task_info.start_idx; i < task_info.end_idx; ++i) {
          precomp_domains[2][i] =
              (point_powers[2][i & (7)]) - (FieldElementT::One());
        }
      },
      period, kTaskSize);
  ...
  task_manager.ParallelFor(
      ...
      [&](const TaskInfo &task_info) {
        for (size_t i = task_info.start_idx; i < task_info.end_idx; ++i) {
          precomp_domains[4][i] =
              (point_powers[3][i & (15)]) - (FieldElementT::One());
        }
      },
      period, kTaskSize);
...
CpuAirDefinition<FieldElementT, 10>::ConstraintsEval(
    ...
    const FieldElementT &point, gsl::span<const FieldElementT> shifts,
  ...
  ASSERT_VERIFIER(neighbors.size() == 49,
                  "Neighbors must contain 49 elements.");
  ...
  const FieldElementT &column6_inter1_row0 =
      neighbors[kColumn6Inter1Row0Neighbor];
  const FieldElementT &column6_inter1_row1 =
      neighbors[kColumn6Inter1Row1Neighbor];
  const FieldElementT &column7_inter1_row0 =
      neighbors[kColumn7Inter1Row0Neighbor];
  const FieldElementT &column7_inter1_row2 =
      neighbors[kColumn7Inter1Row2Neighbor];
  ...
  const FieldElementT npc_reg_0 =
      ((column3_row0) + (cpu__decode__opcode_rc__bit_2)) +
      (FieldElementT::One());
  ...
  FractionFieldElement<FieldElementT> res(FieldElementT::Zero());
  {
...

    {
      ...
      FieldElementT inner_sum = FieldElementT::Zero();
      {
        ...
        const FieldElementT constraint = ((cpu__decode__opcode_rc__bit_0) *
...

    {
      ...
      FieldElementT inner_sum = FieldElementT::Zero();
      {
        ...
        const FieldElementT constraint =
            (((rc16__perm__interaction_elm_) - (column2_row1)) *
             (column6_inter1_row1)) -
            (((rc16__perm__interaction_elm_) - (column0_row1)) *
             (column6_inter1_row0));
      ...
      }
      {
        ...
        const FieldElementT constraint =
            ((rc16__diff_0) * (rc16__diff_0)) - (rc16__diff_0);
...

  {
...

    {
      ...
      FieldElementT inner_sum = FieldElementT::Zero();
      {
        ...
        const FieldElementT constraint =
            (column3_row1) -
            (((((((column1_row0) * (offset_size_)) + (column0_row4)) *
                (offset_size_)) +
               (column0_row8)) *
              (offset_size_)) +
             (column0_row0));
      ...
      }
      {
        ...
        const FieldElementT constraint = ((cpu__decode__flag_op1_base_op0_0) *
      ...
      }
      {
        ...
        const FieldElementT constraint = ((cpu__decode__fp_update_regular_0) *
      ...
      }
      {
        ...
        const FieldElementT constraint =
            ...
            ((((cpu__decode__opcode_rc__bit_0) * (column5_row8)) +
              (((FieldElementT::One()) - (cpu__decode__opcode_rc__bit_0)) *
               (column5_row0))) +
             (column0_row0));
      ...
      }
      {
        ...
        const FieldElementT constraint =
            ...
            ((((cpu__decode__opcode_rc__bit_1) * (column5_row8)) +
              (((FieldElementT::One()) - (cpu__decode__opcode_rc__bit_1)) *
               (column5_row0))) +
             (column0_row8));
      ...
      }
      {
        ...
        const FieldElementT constraint = (cpu__decode__opcode_rc__bit_12) *
                                         ((column3_row9) - (column5_row8));
      ...
      }
      {
        ...
        const FieldElementT constraint = (cpu__decode__opcode_rc__bit_12) *
                                         ((column0_row0) - (half_offset_size_));
      ...
      }
      {
        ...
        const FieldElementT constraint =
            ...
            (((column0_row0) + (FieldElementT::ConstexprFromBigInt(0x2_Z))) -
             (half_offset_size_));
      ...
      }
      {
        ...
        const FieldElementT constraint = (cpu__decode__opcode_rc__bit_14) *
                                         ((column3_row9) - (column5_row12));
...

    {
      ...
      }
      {
        ...
        const FieldElementT constraint =
            (column5_row10) - ((column5_row2) * (column5_row12));
      ...
      }
      {
        ...
        const FieldElementT constraint =
            (column5_row16) -
            ((((column5_row0) +
               ((cpu__decode__opcode_rc__bit_10) * (column5_row12))) +
...

  {
...

    {
      ...
      }
      {
        ...
        const FieldElementT constraint =
            ((memory__address_diff_0) * (memory__address_diff_0)) -
...

  {
...

    {
      ...
      FieldElementT inner_sum = FieldElementT::Zero();
      {
        ...
        const FieldElementT constraint =
            (column6_inter1_row0) - (rc16__perm__public_memory_prod_);
...
CpuAirDefinition<FieldElementT, 10>::DomainEvalsAtPoint(
...
CpuAirDefinition<FieldElementT, 10>::GetTraceGenerationContext() const {
  TraceGenerationContext ctx;

  ASSERT_RELEASE(((trace_length_) + (-1)) < (trace_length_),
                 "Index out of range.");

  ASSERT_RELEASE(((trace_length_) + (-1)) >= (0),
  ...
  ASSERT_RELEASE(IsPowerOfTwo(SafeDiv(trace_length_, 8)),
                 "Dimension should be a power of 2.");

  ASSERT_RELEASE(IsPowerOfTwo(SafeDiv(trace_length_, 2)),
                 "Dimension should be a power of 2.");

  ASSERT_RELEASE((0) < (SafeDiv(trace_length_, 2)), "Index out of range.");

  ASSERT_RELEASE((1) <= (SafeDiv(trace_length_, 2)),
                 "step must not exceed dimension.");

  ASSERT_RELEASE((SafeDiv(trace_length_, 2)) <= (SafeDiv(trace_length_, 2)),
                 "Index out of range.");

  ASSERT_RELEASE((SafeDiv(trace_length_, 2)) >= (0),
                 "Index should be non negative.");

  ASSERT_RELEASE(((SafeDiv(trace_length_, 2)) - (1)) <=
                     (SafeDiv(trace_length_, 2)),
                 "Index out of range.");

  ASSERT_RELEASE(((SafeDiv(trace_length_, 2)) - (1)) >= (0),
                 "Index should be non negative.");

  ASSERT_RELEASE((0) <= (SafeDiv(trace_length_, 2)), "Index out of range.");

  ASSERT_RELEASE((0) <= ((SafeDiv(trace_length_, 2)) - (1)),
  ...
  ASSERT_RELEASE(IsPowerOfTwo(SafeDiv(trace_length_, 16)),
                 "Dimension should be a power of 2.");

  ASSERT_RELEASE(((SafeDiv(trace_length_, 16)) + (-1)) <
                     (SafeDiv(trace_length_, 16)),
                 "Index out of range.");

  ASSERT_RELEASE(((SafeDiv(trace_length_, 16)) + (-1)) >= (0),
                 "Index should be non negative.");

  ASSERT_RELEASE((0) < (SafeDiv(trace_length_, 16)), "Index out of range.");

  ASSERT_RELEASE((1) <= (SafeDiv(trace_length_, 16)),
                 "step must not exceed dimension.");

  ASSERT_RELEASE((SafeDiv(trace_length_, 16)) <= (SafeDiv(trace_length_, 16)),
                 "Index out of range.");

  ASSERT_RELEASE((SafeDiv(trace_length_, 16)) >= (0),
                 "Index should be non negative.");
  ...
  ASSERT_RELEASE((0) <= ((SafeDiv(trace_length_, 16)) - (1)),
                 "start must not exceed stop.");
  ...
  ctx.AddVirtualColumn(
      "mem_pool/addr",
      VirtualColumn(/*column=*/kColumn3Column, /*step=*/2, /*row_offset=*/0));
  ctx.AddVirtualColumn(
      "mem_pool/value",
      VirtualColumn(/*column=*/kColumn3Column, /*step=*/2, /*row_offset=*/1));
  ctx.AddVirtualColumn(
      "memory/sorted/addr",
      VirtualColumn(/*column=*/kColumn4Column, /*step=*/2, /*row_offset=*/0));
  ctx.AddVirtualColumn(
      "memory/sorted/value",
  ...
  ctx.AddVirtualColumn("rc16/perm/cum_prod0",
                       VirtualColumn(
                           /*column=*/kColumn6Inter1Column - kNumColumnsFirst,
                           /*step=*/1, /*row_offset=*/0));
  ctx.AddVirtualColumn("memory/multi_column_perm/perm/cum_prod0",
                       VirtualColumn(
                           /*column=*/kColumn7Inter1Column - kNumColumnsFirst,
                           /*step=*/2, /*row_offset=*/0));
  ctx.AddVirtualColumn(
  ...
  ctx.AddVirtualColumn(
      "cpu/decode/off0",
      VirtualColumn(/*column=*/kColumn0Column, /*step=*/16, /*row_offset=*/0));
  ctx.AddVirtualColumn(
      "cpu/decode/off1",
      VirtualColumn(/*column=*/kColumn0Column, /*step=*/16, /*row_offset=*/8));
  ctx.AddVirtualColumn(
      "cpu/decode/off2",
      VirtualColumn(/*column=*/kColumn0Column, /*step=*/16, /*row_offset=*/4));
  ctx.AddVirtualColumn(
...
CpuAirDefinition<FieldElementT, 10>::GetMask() const {
